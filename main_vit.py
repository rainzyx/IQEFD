...
from 可视化.utils import GradCAM, show_cam_on_image, center_crop_img
...
def main():
    ...
    weights_path = "/DATA/LZJ/rebuilt.vision_transformer/vision_transformer/weights/model-14.pth"
